...
export const THEMES_DATA: Record<string, string[]> = {
  ...
  rosa:      [W,  "#d5d3da","#d16292","#e5e1e9f9","#2d2a32","#a8a1af", "#d1629228",  "#9a8898", RE,        "#ff9800"],
  snow:      [W,  "#e2e5e9","#3a60d6","#eceff4",  "#212630","#acb9cb", "#3a60d624",  "#8898a8", RE,        "#26c6da"],
  solar:     [W,  "#d8cf9a","#e67e22","#e4dbab",  "#2b2718","#9d9365", "#e67e222a",  "#8c8460", RE,        "#27ae60"],
  dracula:   ["#1a0f0f","#1c1111","#ff5e5e","#341d1d",W,"#614040","#ff5e5e2c","#583535","#ff6b6b","#ffd740"],
  comfy:     [W,  "#e9ded5","#a65d3a","#f5ece5",  "#6e4531","#b49e8a", "#a65d3a24",  "#b09080", RE,        "#558b2f"],
